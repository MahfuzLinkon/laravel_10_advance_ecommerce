                        ...
                        <div class="card-body">
                            ...
                            <form method="post" enctype="multipart/form-data" action="{{ route('admin.products.update', $product->slug) }}">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" value="{{ $product->stock_amount }}" name="stock_amount" class="form-control" id="stock_amount">
                                        @error('stock_amount')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="{{ $product->regular_price }}" name="regular_price" class="form-control" id="regular_price">
                                        @error('regular_price')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="{{ $product->selling_price }}" name="selling_price" class="form-control" id="selling_price">
                                        @error('selling_price')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="short_description" id="short_description" cols="30" class="form-control" rows="3">{{ $product->short_description }}</textarea>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="long_description" id="editor" cols="30" rows="10">{!! $product->long_description !!}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-check form-check-primary mb-3">
                                                    <input class="form-check-input" {{ $product->featured_status ? 'checked' : '' }} name="featured_status" value="1" type="checkbox" id="featureProduct" >
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-check form-check-primary mb-3">
                                                    <input class="form-check-input" {{ $product->special_offer ? 'checked' : '' }} name="special_offer" value="1" type="checkbox" id="specialOffer">
